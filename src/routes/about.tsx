...
function About() {
  return (
    <div className="w-full bg-[#101215] text-white">
      <div className="flex h-[38px] items-center border-b border-[#6c6c6cee] px-5 text-xs">/about</div>
      <div className="flex justify-center p-8">
        <img src="/pfp.png" alt="pfp" width={60} height={60} className="h-[60px] w-[60px] select-none rounded-full" draggable={false} />
        <div className="px-4 max-w-2xl">
          ...
          <br />
          <span className="text-[0.9rem] leading-7">when you are bored, <b className="text-[1.2rem] font-semibold">think about how you could make your calculations faster</b></span>
          <br />
          <span className="text-[0.9rem] leading-7">these calculations should be done brain when you are doing an objective paper</span>
        </div>
      </div>
      <div className="mx-auto max-w-4xl px-12 text-[0.87rem] leading-6">
      ...
      <p className="mx-12 mt-8 text-[0.8rem] text-[#afafaf]">
      ...
      <a href="https://github.com/inharul/solvexr" className="mx-12 mt-3 inline-flex w-fit items-center rounded-lg bg-[#9494943f] px-3 py-2 text-[13px]">
        <img src="/github.svg" alt="star on github" width={20} height={20} className="mr-1 h-5 w-5" /> View it on Github
      </a>
      <footer className="flex w-full items-center justify-center gap-2 py-16">
